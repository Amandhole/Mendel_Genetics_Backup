...
urlpatterns = [
    ...
    path('delete_user_test', delete_user_test, name='delete_user_test'),
    path('delete_user_lot', delete_user_lot, name='delete_user_lot'),
    path('show_user_test', show_user_test, name='show_user_test'),
    ...
    path('test_delete_by_admin', test_delete_by_admin,name="test_delete_by_admin"),
    ...
    path('completed_test', completed_test, name="completed_test")
