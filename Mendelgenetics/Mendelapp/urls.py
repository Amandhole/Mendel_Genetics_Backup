...
urlpatterns = [
    ...
    path("send_otp_for_signup_verification", send_otp_for_signup_verification,name="send_otp_for_signup_verification"),
    path("forget_password", forget_password_OTP, name="forget_password"),
    path('view_all_bids_on_my_test_auctioner_side',view_all_bids_on_my_test_auctioner_side, name="view_all_bids_on_my_test_auctioner_side"),
    ...
    path('edit_uploaded_result_bidder', edit_uploaded_result_bidder,name="edit_uploaded_result_bidder"),
